  ...
  return (
    <div>
      ...
      >
        ...
        >
          <h3 className="text-xl font-semibold text-[#010411] mb-4">
            Your Wallet ID
          </h3>
          ...
          <p className="text-sm text-gray-600 mt-3.5">
            Use this ID to receive money from other GofaGuy users.
          </p>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-5">
            <h3 className="text-xl font-semibold text-[#010411]">
              Recent Transactions
            </h3>
            <Button
              variant="link"
              className="text-[#1657FB] hover:text-[#0033CD] px-0 py-0 h-auto"
              asChild
            >
